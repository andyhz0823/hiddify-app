...
// decodeFull decodes all header fields from the given byte slice.
// This is a compatibility shim for the standard qpack API.
func decodeFull(d *qpack.Decoder, b []byte) ([]qpack.HeaderField, error) {
